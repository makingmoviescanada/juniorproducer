    ...
    <div>
      ...
      <section className="w-full px-8 py-20" style={{ backgroundColor: '#E8392A' }}>
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8" style={{ alignItems: 'stretch' }}>
          <div style={{ backgroundColor: '#F0EBE0', boxShadow: '4px 4px 0px #1A1A1A', padding: '40px 32px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100%', minHeight: '320px', borderRadius: '86px' }}>
            <div>
              <h3 style={{ fontFamily: 'var(--font-barlow)', fontWeight: 900, color: '#1A1A1A', fontSize: '1.5rem', lineHeight: 1.2, marginBottom: '20px', textTransform: 'uppercase', letterSpacing: '0.04em' }}>Easily navigate the Canadian funding system.</h3>
          ...
          <div style={{ backgroundColor: '#F0EBE0', boxShadow: '4px 4px 0px #1A1A1A', padding: '40px 32px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100%', minHeight: '320px', borderRadius: '86px' }}>
            <div>
              <h3 style={{ fontFamily: 'var(--font-barlow)', fontWeight: 900, color: '#1A1A1A', fontSize: '1.5rem', lineHeight: 1.2, marginBottom: '20px', textTransform: 'uppercase', letterSpacing: '0.04em' }}>Automatically track deadlines.</h3>
          ...
          <div style={{ backgroundColor: '#F0EBE0', boxShadow: '4px 4px 0px #1A1A1A', padding: '40px 32px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100%', minHeight: '320px', borderRadius: '86px' }}>
            <div>
              <h3 style={{ fontFamily: 'var(--font-barlow)', fontWeight: 900, color: '#1A1A1A', fontSize: '1.5rem', lineHeight: 1.2, marginBottom: '20px', textTransform: 'uppercase', letterSpacing: '0.04em' }}>Effortlessly calculate budgets and tax credits.</h3>
