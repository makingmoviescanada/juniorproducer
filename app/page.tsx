    ...
    <main>
      ...
      <section className="bg-junior-parchment px-6 py-32 md:px-12 lg:px-24 min-h-screen pt-32 relative overflow-hidden">
        <div className="max-w-7xl mx-auto w-full relative">
          {/* H1 spans full width */}
          <ScrollReveal>
            <h1 className="hero-h1 font-display text-junior-black text-5xl md:text-6xl lg:text-7xl font-black tracking-wider mb-12 leading-tight text-pretty">
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start">
            <ScrollReveal className="flex-1">
              <h2 className="hero-h2 font-display text-junior-black text-xl md:text-2xl font-semibold tracking-wide mb-8 leading-relaxed text-pretty">
              ...
              <a
                href="#cta"
                className="btn-cta inline-block px-6 py-3 bg-junior-red border-2 border-junior-black text-junior-white font-bold uppercase tracking-wider shadow-hard-red-sm btn-hover font-sans text-sm"
      ...
      <section className="bg-junior-red px-6 py-32 md:px-12 lg:px-24 border-t-2 border-junior-black">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <ScrollReveal>
              <h2 className="section-headline font-display text-junior-white text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-wider mb-8 text-balance leading-tight">
                JUNIOR IS YOUR SECOND BRAIN.
              </h2>
              <p className="body-copy text-junior-white/90 text-lg md:text-xl leading-relaxed font-sans mb-6">
              ...
              <p className="body-copy text-junior-white/90 text-lg md:text-xl leading-relaxed font-sans">
      ...
      <section id="features" className="bg-junior-parchment px-6 py-32 md:px-12 lg:px-24 border-t-2 border-junior-black">
        <div className="max-w-7xl mx-auto">
          <ScrollReveal>
            <h2 className="section-headline font-display text-junior-black text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-wider mb-4 text-center text-balance">
              No budget, no team, no problem.
            </h2>
            <div className="max-w-2xl mx-auto">
              <p className="body-copy text-junior-black/80 text-lg md:text-xl leading-relaxed font-sans text-left mb-16">
      ...
      <section id="why-we-built-it" className="bg-junior-parchment px-6 py-32 md:px-12 lg:px-24 border-t-2 border-junior-black">
        <div className="max-w-7xl mx-auto">
          ...
          <ScrollReveal>
            <h2 className="section-headline font-display text-junior-black text-4xl md:text-5xl font-black uppercase tracking-wider mb-8 leading-tight text-center">
              BUILT BY CANADIAN FILMMAKERS,<br />FOR CANADIAN FILMMAKERS.
            </h2>
          </ScrollReveal>
          
          <ScrollReveal delay={100}>
            <p className="body-copy text-junior-black/80 text-lg leading-relaxed font-sans mb-16 text-center max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <ScrollReveal delay={150} className="flex flex-col gap-4">
              <p className="body-copy text-junior-black/80 text-lg leading-relaxed font-sans border-2 border-junior-black p-6">
      ...
      <section id="cta" className="bg-junior-red px-6 py-24 md:px-12 lg:px-24 border-t-2 border-junior-black md:py-32">
        <div className="max-w-3xl mx-auto text-center">
          <ScrollReveal>
            <h2 className="hero-h1 font-display text-junior-white text-5xl md:text-6xl lg:text-7xl font-black uppercase tracking-wider mb-4 text-balance leading-tight">
