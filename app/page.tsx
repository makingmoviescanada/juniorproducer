      ...
      <section className="w-full px-8 py-20" style={{ backgroundColor: '#F0EBE0' }}>
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 flex justify-center">
            <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/AI%20work%20assistant%20concept%205-cbBkjxz0NKeVgJrfyqYTiuvHt3cozy.png" alt="Junior AI assistant with person" style={{ width: '100%', maxWidth: '500px', objectFit: 'contain', filter: 'grayscale(100%) contrast(1.1)' }} />
          </div>
        </div>
      </section>
