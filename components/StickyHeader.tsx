    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 md:px-12 lg:px-24 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          <a 
            href="#features" 
            className="nav-link font-sans text-sm text-junior-black/70 hover:text-junior-black transition-colors"
          >
            What Junior Does
          </a>
          <a 
        ...
        <a
          href="#cta"
          className="btn-cta px-4 py-2 bg-junior-red border-2 border-junior-black text-junior-white font-bold uppercase tracking-wider shadow-hard-red-sm btn-hover font-sans text-xs"
        >
          Get Early Access
        </a>
      </div>
